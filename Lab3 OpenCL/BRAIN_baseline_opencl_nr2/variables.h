...
#define CELLCOMP_BASEADDR(x,y,stride)		(x * stride * CELL_COMP_PARAMS_SIZE + y * CELL_COMP_PARAMS_SIZE)
#define CELLCOMP_BASEADDR_OPENCL(x,y)		(x * get_global_size(1) * CELL_COMP_PARAMS_SIZE + y * CELL_COMP_PARAMS_SIZE)