...
// void writeCellCompParameters(cl_mod_prec* cellCompParamsPtr, unsigned int simStep, cl_mod_prec iApp);
// void writeCellCompParametersOneCell(cl_mod_prec* cellCompParamsPtr, unsigned int simStep, cl_mod_prec iApp, unsigned int x, unsigned int y);
void deleteFiles();